...
public class OrderToolsTable {
    private int idOrder;
    private String orderIdOrder;
    private Integer idUserOrder;
    private CarTable idCarOrder;
    ...
    private CarStoreTable idGetCarOrder;
    private CarStoreTable idReturnCarOrder;
    ...
    @Basic
    @JoinColumn(name = "id_car_order", nullable = true)
    @OneToOne
    public CarTable getIdCarOrder() {
        return idCarOrder;
    }

    public void setIdCarOrder(CarTable idCarOrder) {
        this.idCarOrder = idCarOrder;
    }

    @Basic
    @JoinColumn(name = "id_get_car_order", nullable = true)
    @OneToOne
    public CarStoreTable getIdGetCarOrder() {
        return idGetCarOrder;
    }

    public void setIdGetCarOrder(CarStoreTable idGetCarOrder) {
        this.idGetCarOrder = idGetCarOrder;
    }

    @Basic
    @JoinColumn(name = "id_return_car_order", nullable = true)
    @OneToOne
    public CarStoreTable getIdReturnCarOrder() {
        return idReturnCarOrder;
    }

    public void setIdReturnCarOrder(CarStoreTable idReturnCarOrder) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OrderToolsTable)) return false;
        OrderToolsTable that = (OrderToolsTable) o;
